...
def send_email_with_verification_code_for_registration(background_tasks: BackgroundTasks, executor: MailSenderExecutor,\
                                                        recipient: str, verification_code: str):
